...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: '/solicitudes-repuesto', label: 'Solicitudes',
        icon: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" /></svg>
      },
      {
      ...
      {
        to: '/documentos-pago', label: 'Documentos',
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 h-screen bg-slate-800 flex flex-col shrink-0">
      <div className="px-6 py-5 border-b border-slate-700">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="font-bold text-white text-sm leading-tight">AutoFix SpA</p>
            <p className="text-slate-400 text-xs">Taller Mecánico</p>
          </div>
        </div>
      </div>
